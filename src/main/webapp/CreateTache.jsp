...
<div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-md mt-8">
    <h1 class="text-2xl font-bold mb-6 text-center">Create New Tache</h1>
    <form action="${pageContext.request.contextPath}/insertTache" method="POST" class="space-y-4">
        <div>
            <label for="nom" class="block font-medium">Tache Name</label>
        ...
        <div>
            <label for="date_debut" class="block font-medium">Start Date</label>
        ...
        <div class="flex justify-between items-center">
            <button type="submit"
                    src="CreatTache.jsp"class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">Create Tache</button>
            <a href="TacheServlet" class="text-blue-500 hover:underline">Back to Tache List</a>
        </div>
    </form>
</div>
</body>
