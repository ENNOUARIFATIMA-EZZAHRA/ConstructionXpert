...
<%@ page import="Controller.ProjetServlet" %>
<!DOCTYPE html>
<html lang="fr">
<head>
    <meta charset="UTF-8">
...
<nav class="flex items-center justify-between p-4 shadow-md">
    ...
    <a href="ListProjets.jsp" class="hidden md:inline-block px-4 py-2 bg-pink-500 text-white rounded hover:bg-pink-600">Create projet</a>
</nav>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="border border-gray-300 shadow-sm rounded-lg overflow-hidden">
            <div class="bg-gray-200 px-4 py-2 flex justify-between items-center">
                ...
                <div>
                    <a href="update.jsp?id=<%= projet.getId() %>" class="text-blue-500 hover:text-blue-700 mx-2">
                        <i class="fas fa-edit"></i>
                    </a>
                    <a href="delete.jsp?id=<%= projet.getId() %>" class="text-red-500 hover:text-red-700">
            ...
            <div class="p-4 space-y-2">
                ...
                <p class="text-sm text-gray-600"><%= ProjetModel.getDescription() %></p>
