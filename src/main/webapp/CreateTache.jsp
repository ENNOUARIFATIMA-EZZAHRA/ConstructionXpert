...
<nav class="flex justify-between items-start bg-white text-black p-4 border-b-2 border-gray-200">
    ...
    <div class="flex space-x-8 mt-4">
        ...
        <a href="CreateProjet.jsp" class="hover:text-blue-500 bold-100">Projet</a>
        <a href="#" class="hover:text-blue-500 text-bold-500 ">Ressource</a>
    </div>
...
<div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-md mt-8">
    ...
    <form action="${pageContext.request.contextPath}/insert" method="POST" class="space-y-4">
        ...
        <div class="flex justify-between items-center">
            <button type="submit"
                    src="CreatProjet.jsp"class="bg-blue-500 text-white px-4 py-2 rounded-lg hover:bg-blue-600">Create Project</button>
            <a href="ProjetServlet" class="text-blue-500 hover:underline">Back to Tache List</a>
        </div>
    </form>
</div>
</body>
